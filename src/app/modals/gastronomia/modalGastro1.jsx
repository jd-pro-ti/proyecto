...
export default function ModalPlaya({ show, onClose, onNext }) {
  const opciones = [
    { id: 'comida tipica', label: 'Comida tipica', icon: '/imagenes/gastro/gastro1.svg' },
    { id: 'antojitos', label: 'Antojitos', icon: '/imagenes/gastro/gastro2.svg' },
    { id: 'comida gourmet', label: 'Comida gourmet', icon: '/imagenes/gastro/gastro3.svg' },
    { id: 'opcione veganas', label: 'Opcione veganas', icon: '/imagenes/gastro/gastro4.svg' },
    { id: 'dulces tipicos', label: 'Dulces tipicos', icon: '/imagenes/gastro/gastro5.svg' },
  ];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm transition-opacity duration-300">
      ...
      >
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">¿Qué tipo de gastronomia prefieres?</h2>
