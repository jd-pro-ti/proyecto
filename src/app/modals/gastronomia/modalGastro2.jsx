...
export default function ModalPlaya({ show, onClose, onNext }) {
  const opciones = [
    { id: 'taller de comida', label: 'Taller de comida', icon: '/imagenes/gastro/gastro6.svg' },
    { id: 'mercados', label: 'Mercados', icon: '/imagenes/gastro/gastro7.svg' },
    { id: 'tequila o mescal', label: 'Tequila o mescal', icon: '/imagenes/gastro/gastro8.svg' },
    { id: 'chef tradicional', label: 'Chef tradicional', icon: '/imagenes/gastro/gastro9.svg' },
    { id: 'tuor de comida', label: 'Tuor de comida', icon: '/imagenes/gastro/gastro10.svg' },
  ];
