  ...
  const resultados = [
    {
      ...
      descripcion: "Disfruta de un ambiente tranquilo para relajarte o practicar surf. Ideal para quienes buscan conectar con el mar."
    },
    {
      nombre: "Costa michoacana",
      descripcion: "Un paraíso natural, formaciones rocosas impresionantes y tortugas marinas."
    }
  ];
