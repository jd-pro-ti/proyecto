...
export default function ModalPlaya({ show, onClose, onNext }) {
  const opciones = [
    ...
    { id: 'gastronomia', label: 'Gastronomia', icon: '/imagenes/playa/playa8.svg' },
    { id: 'actividades en lancha', label: 'Actividades en lancha', icon: '/imagenes/playa/playa9.svg' },
    { id: 'hospedaje', label: 'Hospedaje', icon: '/imagenes/playa/playa10.svg' },
  ];
