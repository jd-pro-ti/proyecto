...
export default function ModalPlaya({ show, onClose, onNext }) {
  const opciones = [
    { id: 'por la mañana', label: 'Por la mañana', icon: '/imagenes/playa/playa11.svg' },
    { id: 'al medio dia', label: 'Al medio dia', icon: '/imagenes/playa/playa12.svg' },
    { id: 'por la tarde', label: 'Por la tarde', icon: '/imagenes/playa/playa13.svg' },
    { id: 'al anochecer', label: 'Al anochecer', icon: '/imagenes/playa/playa14.svg' },
    { id: 'todo el dia', label: 'todo el dia', icon: '/imagenes/playa/playa15.svg' },
  ];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm transition-opacity duration-300">
      ...
      >
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">¿En que momento prefieres hacer las actividades?</h2>
