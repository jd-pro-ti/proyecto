...
export default function ModalPlaya1({ show, onClose, onNext, onBack }) {
  const opciones = [
    { id: 'tranquilidad', label: 'Tranquilidad', icon: '/imagenes/playa/playa1.svg' },
    { id: 'aventura', label: 'Aventura', icon: '/imagenes/playa/playa2.svg' },
    { id: 'familiar', label: 'Familiar y segura', icon: '/imagenes/playa/playa3.svg' },
    { id: 'atardeceres', label: 'Atardeceres', icon: '/imagenes/playa/playa4.svg' },
    { id: 'naturaleza', label: 'Naturaleza', icon: '/imagenes/playa/playa5.svg' },
  ];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm transition-opacity duration-300">
      ...
      >
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">¿Qué tipo de playa buscas?</h2>
