...
export default function ModalResultados({ show, onClose, onSearch }) {
  const resultados = [
    {
      nombre: "Pátzcuaro",
      descripcion: "El alma de Michoacán, famoso por su lago, artesanías y la Noche de Muertos. Imperdible su plaza central y las islas.",
    },
    {
      nombre: "Tlalpujahua",
      descripcion: "Pueblo minero convertido en capital de las esferas navideñas. Sus calles empedradas y paisajes te transportarán en el tiempo.",
    }
  ];
