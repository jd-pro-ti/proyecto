...
export default function ModalPlaya({ show, onClose, onNext }) {
  const opciones = [
    { id: 'dia de muertos', label: 'Dia de muertos', icon: '/imagenes/pueblo/pueblo11.svg' },
    { id: 'navidad', label: 'Navidad', icon: '/imagenes/pueblo/pueblo12.svg' },
    { id: 'fiestas patronales', label: 'Fiestas patronales', icon: '/imagenes/pueblo/pueblo14.svg' },
    { id: 'vacaciones de verano', label: 'Vacaciones de verano', icon: '/imagenes/pueblo/pueblo13.svg' },
  ];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-70 backdrop-blur-sm transition-opacity duration-300">
      ...
      >
        <div className="text-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800">¿En que momento prefieres visitar?</h2>
